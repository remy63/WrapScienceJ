...
import wrapScienceJ.metaData.container.attribute.MetaInteger;
...
public class IntegerSetSingle extends MetaValue{
	
	MetaInteger m_metaValue;
	 ...
	 */
	public IntegerSetSingle(String fileNamePostfix, String shortDescription, RetrievalPolicy retrievalPolicy) {
		super(fileNamePostfix, retrievalPolicy, "");
		this.m_value = 0;
		this.m_metaValue = new MetaInteger(shortDescription);
	...
	public IntegerSetSingle(String fileNamePostfix, String shortDescription, RetrievalPolicy retrievalPolicy,
		...
		this.m_metaValue = new MetaInteger(shortDescription, initValue);
		addAttribute(this.m_metaValue);
	}
	 ...
	 */
	public IntegerSetSingle duplicate(){
		return new IntegerSetSingle(getTitle(), this.m_metaValue.getShortDescription(), 
