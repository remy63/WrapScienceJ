 ...
 * these coordinates generally don't take high values so that they fit in a double.
 *
...
public class VoxelDouble {
	 ...
	 */
	public VoxelDouble() {
		this.m_coordinates = new double[3];
	}
	 ...
	 */
	public double getCoord(CoordinateAxis axis){
		switch(axis){
			case X: return getX();
			case Y: return getY();
			case Z: return getZ();
	 ...
	 * @param value the new value of the i^th coordinate of the voxel
	 */
	public void setCoord(CoordinateAxis axis, double value){
		switch(axis){
			case X: setX(value);
					break;
			case Y: setY(value);
	 ...
	 */
	public void shiftCoordinates (VoxelDouble voxel) {   
	 ...
	 */
	public void multipliy (double a, double b, double c) { 
