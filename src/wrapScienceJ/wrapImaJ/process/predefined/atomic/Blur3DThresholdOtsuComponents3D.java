...
*     http://malgouyres.org                                                    * 
*     File: Blur3DThresholdOtsuComponents3D.java                               * 
*                                                                              * 
 ...
 *
 */
public class Blur3DThresholdOtsuComponents3D extends GenericImageProcessConcrete {
	 ...
	 */
	public Blur3DThresholdOtsuComponents3D(ImageCore image, String title, RetrievalPolicy policy,
	 ...
	 */
	public Blur3DThresholdOtsuComponents3D(){
		super();
	}
	...
	public class ProcessMetaData extends MetaDataSet {
		...
		public void debugAttrib(){
			System.err.println("Attributes Components: threshold("+getVolumeThreshold()
														+"), foreground(" +getForegroungColor()
														 +"), removeBorder("+removeBorderComponents()
														 +"), setColors("+setRandomColors()+")");
		}
	}
	...
	public Object runProcess(Object arg, String option) {
		...
		image.getImageBlur().getBinomialBlur(6, 6, 1);
		System.err.println("Blurr done. Thresholding...");
		image.getImageThresholding().thresholdImageAndBinarize(ThresholdingOption.Otsu, true);
	...
	public static void main(String[] args) {
		try {
			Blur3DThresholdOtsuComponents3D process = new Blur3DThresholdOtsuComponents3D(
